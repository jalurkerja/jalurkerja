	...
	<div class="card">
		<div id="content">
			...
			<?php
				...
				$tab1->setnoborder();
				$tab1->add_tab_title($v->w("all_applicant")." ($num_all_applicant)","load_applicant_management('all_applicant','".$_keyword."','applied_date','1','".$_key_id."');");
				$tab1->add_tab_title($v->w("viewed")." ($num_applicant_1)","load_applicant_management('viewed','".$_keyword."','applied_date','1','".$_key_id."');");
				$tab1->add_tab_title($v->w("unviewed")." ($num_applicant_0)","load_applicant_management('unviewed','".$_keyword."','applied_date','1','".$_key_id."');");
			...
			<?php if($_tabid == "viewed" || $_tabid == "quilified" || $_tabid == "denied" || $_tabid == "quilified" || $_tabid == "interviewed" || $_tabid == "not_present" || $_tabid == "accepted"){ ?>
				...
				<?php
					...
					$tab2->setnoborder();
					$tab2->add_tab_title($v->w("viewed")." ($num_applicant_1)","load_applicant_management('viewed','".$_keyword."','applied_date','1','".$_key_id."');");
					$tab2->add_tab_title($v->w("quilified")." ($num_applicant_2)","load_applicant_management('quilified','".$_keyword."','applied_date','1','".$_key_id."');");
					$tab2->add_tab_title($v->w("denied")." ($num_applicant_3)","load_applicant_management('denied','".$_keyword."','applied_date','1','".$_key_id."');");
				...
				<?php if($_tabid == "quilified" || $_tabid == "interviewed" || $_tabid == "not_present" || $_tabid == "accepted"){ ?>
					...
					<?php
						...
						$tab3->setnoborder();
						$tab3->add_tab_title($v->w("quilified")." ($num_applicant_2)","load_applicant_management('quilified','".$_keyword."','applied_date','1','".$_key_id."');");
						$tab3->add_tab_title($v->w("interviewed")." ($num_applicant_4)","load_applicant_management('interviewed','".$_keyword."','applied_date','1','".$_key_id."');");
						$tab3->add_tab_title($v->w("not_present")." ($num_applicant_5)","load_applicant_management('not_present','".$_keyword."','applied_date','1','".$_key_id."');");
					...
					<?php if($_tabid == "interviewed" || $_tabid == "accepted"){ ?>
						...
						<?php
							...
							$tab4->setnoborder();
							$tab4->add_tab_title($v->w("interviewed")." ($num_applicant_4)","load_applicant_management('interviewed','".$_keyword."','applied_date','1','".$_key_id."');");
							$tab4->add_tab_title($v->w("accepted")." ($num_applicant_6)","load_applicant_management('accepted','".$_keyword."','applied_date','1','".$_key_id."');");
