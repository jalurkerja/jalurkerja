<div class="card">
	<div id="content">
		...
		<?php
			$db->addtable("saved_opportunities");$db->where("user_id",$__user_id);$db->order("created_at DESC");
			$applied_opportunities = $db->fetch_data(true);
			echo $t->start("","","content_data");
			echo $t->header(array("No","Opportunity Id","Company Name","Title","Industry","Saved At"));
